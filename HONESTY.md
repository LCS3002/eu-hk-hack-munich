...
## TL;DR
We reused **UI components and visual scaffolding only** from our team's earlier project. **Everything that makes this product *FaanSail* — the smart contracts, the AI proof-of-trade gate, the chain wiring, the concept, and the data — was built during the hackathon.**
...
- **Project scaffold** — Next 15 + React 19 + React-Three-Fiber + Tailwind v4 setup and font wiring (`layout.tsx`: Inter / Space Grotesk / JetBrains Mono via `next/font`).
